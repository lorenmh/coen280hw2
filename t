...
INSERT INTO person VALUES (
  1, 'Brian de forma', TO_DATE('09/11/40', 'MM/DD/YY'), 'M', 'New York', 'Director'
);

INSERT INTO person VALUES (
  2, 'Martin Brest', TO_DATE('08/8/51', 'M', 'San Jose', 'Director'
);

INSERT INTO person VALUES (
  3, 'Scarlett Johanson', TO_DATE('011/22/84', 'F', 'Austin', 'Actor'
);

INSERT INTO person VALUES (
  4, 'Luc Besson', TO_DATE('05/30/75', 'F', 'Paris', 'Director'
);

INSERT INTO person VALUES (
  5, 'Morgan Freeman', TO_DATE('06/5/53', 'M', 'Canberra', 'Actor'
);

INSERT INTO person VALUES (
  6, 'Al Pacino', TO_DATE('011/12/56', 'M', 'Portland', 'Actor'
);

INSERT INTO person VALUES (
  7, 'Angelina Jolie', TO_DATE('03/3/70', 'F', 'Seattle', 'Actor'
);

INSERT INTO person VALUES (
  8, 'Brad Pitt', TO_DATE('04/4/75', 'M', 'London', 'Actor'
);

INSERT INTO person VALUES (
  9, 'Tom Hanks', TO_DATE('05/19/64', 'M', 'Perth', 'Actor'
);

INSERT INTO person VALUES (
  10, 'Jessica Alba', TO_DATE('08/7/83', 'F', 'Seoul', 'Actor'
);

INSERT INTO person VALUES (
  12, 'Alex Parish', TO_DATE('07/9/77', 'F', 'San Jose', 'Actor'
);

INSERT INTO person VALUES (
  13, 'Jack Nicholson', TO_DATE('011/13/58', 'M', 'Austin', 'Actor'
);

INSERT INTO person VALUES (
  15, 'Harrison Ford', TO_DATE('09/11/57', 'M', 'Canberra', 'Actor'
);

INSERT INTO person VALUES (
  16, 'Julia Roberts', TO_DATE('01/1/67', 'F', 'Portland', 'Actor'
);

INSERT INTO person VALUES (
  17, 'Matt Damon', TO_DATE('01/7/71', 'M', 'Seattle', 'Actor'
);

INSERT INTO person VALUES (
  18, 'Jennifer Lawrence', TO_DATE('02/2/62', 'F', 'London', 'Actor'
);

INSERT INTO person VALUES (
  19, 'George clooney', TO_DATE('03/3/65', 'M', 'Perth', 'Actor'
);

INSERT INTO person VALUES (
  20, 'Jennifer Aniston', TO_DATE('04/4/68', 'F', 'Seoul', 'Actor'
);
